        ...
        <div class="main-content">
            <div class="row">
                <div class="col-xs-12 clearfix">
								...
								<h3 class="center">New <?php echo Inflector::humanize(Inflector::delimit($singleModel)); ?></h3>
							</div>
					</div>
					<hr />
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8 col-sm-offset-2" id="newForm">
...
jQuery(document).ready(function() {
	jQuery("#newForm").load("/admin/partial_new.php?model=<?php echo $model; ?>");
